...
class ProfessorTest {
    ...
    void deveRetornarCoordenadorProfessor() {
        Professor professor = new Professor("Marco Antônio");
        Professor professorCoordenador = new Professor("Júlia Conde");
        professorCoordenador.setNome("Júlia  Araujo");
        Curso curso = new Curso();
        curso.setCoordenacao(professorCoordenador);
        professor.setContratacao(curso);

        assertEquals("Júlia  Araujo", professor.getCoordenadorProfessor());
    }
}